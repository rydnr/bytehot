...
<body>
    ...
    <div class="footer">
        ByteHot - Revolutionary JVM Hot-Swapping | <a href="https://github.com/rydnr/bytehot">GitHub</a>
    </div>
</body>
</html>
HTML_EOF
...
if [ -f "bytehot/implementation.org" ]; then
    echo "📄 Converting implementation.org to implementation-content.html..."
    pandoc -f org -t html5 --toc bytehot/implementation.org -o bytehot/implementation-content.html || echo "implementation.org conversion failed"
fi
